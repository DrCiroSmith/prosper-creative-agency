...
import { Download, FileText, CheckCircle2, ArrowRight, ShieldCheck, Camera, Mic2, Video } from 'lucide-react';
                    ...
                    <div className="lg:sticky lg:top-28">
                        ...
                        <div className="space-y-3">
                            {GUIDE_CHAPTERS.map((ch, i) => (
                                <div key={ch}
                                    className="flex items-center gap-4 py-3 px-4 rounded-xl bg-[#111] border border-white/5 hover:border-[#00AEEF]/20 transition-all">
                                    <span className="text-[#00AEEF] font-black text-xs w-6 shrink-0"
                                        style={{ fontFamily: 'Montserrat, sans-serif' }}>
                                        0{i + 1}
                                    </span>
                                ...
                                <div className="relative bg-[#111] border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
                                    ...
                                    <div className="p-8 sm:p-10">
                                        ...
                                        <div className="mt-8 flex items-center justify-center gap-2 text-gray-600 text-xs">
                                            ...
                                            100% Free · Instant PDF Access · No Credit Card Needed
                                        </div>
                                        ...
                                        <div className="mt-8 pt-8 border-t border-white/5">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <p className="text-gray-600 text-xs leading-relaxed">
                                                    Prosper Creative Agency · Photography · Video · Podcasts · Events
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="relative bg-[#111] border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
                                    ...
                                    <div className="p-10 text-center">
                                        ...
                                        <p className="text-gray-400 text-sm mb-8 leading-relaxed">
                                            Your download is starting automatically. If it doesn't, click below.
                                        </p>
                                        <div className="space-y-3">
                                            <a
