    ...
    return (
        <div className="min-h-screen bg-black font-['Inter',sans-serif] selection:bg-[#00AEEF] selection:text-black">
            ...
            <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-32 pb-20 px-6">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#00AEEF]/5 rounded-full blur-[120px] animate-pulse pointer-events-none" />

                <div className="relative z-10 text-center max-w-5xl mx-auto">
                    <div className="reveal mb-10">
                        <span className="inline-block py-1.5 px-6 rounded-full border border-white/10 glass-dark text-[10px] font-black uppercase tracking-[0.3em] text-[#00AEEF]">
                            Prosper Creative Agency
                        </span>
                    </div>

                    <h1 className="reveal-delayed-1 text-7xl md:text-9xl font-['Montserrat',sans-serif] font-black uppercase leading-[0.85] tracking-tighter mb-10">
                        WE CAPTURE <br />
                        <span className="text-transparent" style={{ WebkitTextStroke: '2px rgba(255,255,255,0.2)', fontFamily: 'Montserrat, sans-serif' }}>YOUR STORY</span>
                    </h1>
            ...
            <section className="py-40 px-6 border-t border-white/5 bg-black">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-24 reveal">
                        <h2 className="text-5xl md:text-7xl font-['Montserrat',sans-serif] font-black uppercase tracking-tight mb-6">
                            CREATIVE <span className="text-[#00AEEF]">SOLUTIONS</span>
                        </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {SERVICES.map((s, i) => (
                            <div key={i} className={`reveal-delayed-${i + 1} glass-card p-10 rounded-[40px] flex flex-col items-start gap-8`}>
                                <div className="w-16 h-16 rounded-3xl bg-[#00AEEF] flex items-center justify-center text-black">
                                    {s.icon}
                                </div>
                                <div>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-24 items-center">
                        <div className="reveal">
                            <h2 className="text-5xl font-['Montserrat',sans-serif] font-black uppercase text-white leading-tight mb-10">
                                CREATIVITY<br />MEETS<br /><span className="text-[#00AEEF]">STRATEGY</span>
                            </h2>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            {[
                                ...
                                <div key={label} className={`reveal-delayed-${i + 1} bg-[#0a0a0a] border border-white/5 rounded-[32px] p-10 group hover:border-[#00AEEF]/30 transition-all`}>
                                    <div className="text-4xl font-black text-[#00AEEF] mb-2 font-['Montserrat',sans-serif] tracking-tighter group-hover:scale-105 transition-transform">{num}</div>
            ...
            <section className="py-40 px-6 relative overflow-hidden bg-black border-t border-white/5">
                <div className="absolute right-0 top-0 w-96 h-96 bg-[#00AEEF]/5 blur-[120px] rounded-full pointer-events-none" />
                <div className="max-w-5xl mx-auto relative z-10">
                    <div className="glass-card p-20 md:p-32 rounded-[60px] text-center border-white/10">
                        <h2 className="text-5xl md:text-8xl font-['Montserrat',sans-serif] font-black uppercase mb-10 leading-[0.9] tracking-tighter">
                            READY TO <br /><span className="text-[#00AEEF]">PROSPER?</span>
                        </h2>
